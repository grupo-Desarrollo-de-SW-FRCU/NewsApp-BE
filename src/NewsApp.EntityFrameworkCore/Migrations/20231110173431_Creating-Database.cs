    ...
    public partial class CreatingDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SearchString = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    StartDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ResultsAmount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppThemes_AppThemes_ParentThemeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppNotifications_Alert_AlertId",
                        column: x => x.AlertId,
            ...
            migrationBuilder.CreateTable(
                name: "AppAlertsSearches",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SearchOfAlertId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchOfFailureId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppNotificationsApp_AppNotifications_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppNotificationsMail_AppNotifications_Id",
                        column: x => x.Id,
                        principalTable: "AppNotifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppAlertsSearches_SearchOfAlertId",
                table: "AppAlertsSearches",
                column: "SearchOfAlertId",
                unique: true,
                filter: "[SearchOfAlertId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_AppAlertsThemes_ThemeOfAlertId",
                table: "AppAlertsThemes",
                column: "ThemeOfAlertId",
                unique: true,
                filter: "[ThemeOfAlertId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppArticles_ThemeId",
                table: "AppArticles",
                column: "ThemeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppErrors_SearchOfFailureId",
                table: "AppErrors",
                column: "SearchOfFailureId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppThemes_ParentThemeId",
                table: "AppThemes",
